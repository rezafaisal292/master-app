...
$title = 'Tambah'; $method = 'post'; $action = 'customer.store'; $readonly='';
if ($segment !== 'create' ) { $title = 'Ubah'; $method = 'put'; $action = ['customer.update', $d->id]; $readonly='readonly';  }
@endphp
@extends('adminlte::page')
@section('title', env('APP_NAME').'::'.$title.' Customer')
@section('content')
